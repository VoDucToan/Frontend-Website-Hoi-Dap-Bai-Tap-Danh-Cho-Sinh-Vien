...
function ModalUpdateAnswer(props) {
    ...
    const handleSaveChanges = async () => {
        ...
        const dataUpdateEditPost = await updateEditPost(editAnswer.id, '', detailAnswer,
            plainTextDetailAnswer, editAnswer.edit_summary, imageAnswer, []);
